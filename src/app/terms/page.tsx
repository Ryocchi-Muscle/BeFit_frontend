...
const TermsOfService = () => {
  return (
    <div className="pt-8 px-6 md:px-16 lg:px-24 text-gray-700">
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">1.本規約への同意</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">3.利用登録</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">4.ログイン情報の管理</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">5.コンテンツのご利用</h2>
        <p>
          当社は、ユーザーに対し、本サービスが提供する文章、画像、動画、音声、ソフトウェア、プログラム、コードその他のコンテンツについて、本サービスの利用範囲内における私的な利用を許諾します。
        </p>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">7.反社会的勢力の排除</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">8.利用制限</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">9.本サービスの提供の停止</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">10.退会</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">11.保証の否認</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">12.免責</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">13.サービス内容の変更</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">14.利用規約の変更</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">15.個人情報の取扱い</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">16.通知または連絡</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">17.権利義務の譲渡</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">18.適用関係</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">19.分離可能性</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">20.準拠法・裁判管轄</h2>
        <p>
