  ...
  return (
    <div className="pt-8 px-6 md:px-16 lg:px-24 text-gray-700">
      <header className="mb-8">
        <h1 className="text-2xl font-bold text-center mb-2">利用規約</h1>
        <p className="text-center">
          当サイトの利用にあたり、以下の規約をご確認ください。
        </p>
      </header>
      <section className="mb-12">
        <h2 className="text-xl font-semibold mb-2">利用規約</h2>
        <p>
          当サイトの利用にあたり、以下の規約をご確認ください。この利用規約(以下、「本規約」といいます。)は、本サービス(本サイトを含むものとし、以下、特に両者を区別しません。)の利用条件を定めるものです。本規約は、本サービスを利用するすべてのユーザーに適用されます。
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-4">1. 本規約への同意</h2>
        <p>
          ユーザーは、本サービスを利用することによって、本規約に有効かつ取り消し不能な同意をしたものとみなされます。本規約に同意しないユーザーは、本サービスをご利用いただけません。
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-4">2. 免責事項</h2>
        <ol className="list-decimal list-inside ml-4">
          <li>
            <strong>身体変化の保証</strong>
            <br />
            当アプリは、フィットネスや健康に関する情報やプログラムを提供しますが、「必ず痩せる」や「必ず理想の体型になる」等の身体変化を保証するものではありません。個々の成果は、多くの要因に依存し、個人差があります。
          </li>
          <li>
            <strong>健康状態の悪化およびトレーニング中のトラブル</strong>
            <br />
            当アプリの使用により、ユーザーの健康状態が悪化した場合やトレーニング中に起こったトラブルに関して、当社は一切の責任を負いません。
          </li>
          <li>
            <strong>医師や専門家の助言の推奨</strong>
            <br />
            健康状態が良くないユーザーは、当アプリを使用する前に必ず医師や専門家の助言を受けてください。これにより生じたトラブルについて、当社は一切の責任を負いません。
          </li>
          <li>
            <strong>プログラム内容の模倣禁止</strong>
            <br />
            当アプリ内のトレーニングプログラムやコンテンツを無断で模倣し、利益を得ることを禁じます。違反が発覚した場合、法的措置を講じることがあります。
          </li>
        </ol>

        <h2 className="text-xl font-semibold mb-2 mt-4">3. 利用登録</h2>
        <p>
        ...
        <p>
          当社は、ユーザーに対し、本サービスが提供する文章、画像、動画、音声、ソフトウェア、プログラム、コードその他のコンテンツについて、本サービスの利用範囲内における私的な利用を許諾します。理由の如何を問わず、ユーザーが本サービスを利用する権利を失った場合、本サービスの一切のコンテンツの利用ができなくなることを、ユーザーは予め承諾するものとします。
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-4">6. 禁止事項</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mb-2 mt-4">8. 利用制限</h2>
        <p>
        ...
        <p>
          当社は、以下のいずれかの事由があると判断した場合、ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。当社は、この場合にユーザーまたは第三者が被ったいかなる不利益または損害についても、一切の責任を負いません。
        </p>
        <ul className="list-disc list-inside ml-4">
          <li>
        ...
        <h2 className="text-xl font-semibold mb-2 mt-4">10. 退会</h2>
        <p>
          ユーザーは、当社の定める手続により、利用登録を抹消し、本サービスから退会できるものとします。
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-4">11. 保証の否認</h2>
        <p>
          当社は、本サービスや本サービスが提供するコンテンツに、システムバグや第三者の権利侵害が含まれないことを保証するものではありません。また、安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性を保証するものでもありません。
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-4">12. 免責</h2>
        <p>
          当社は、本サービスに関してユーザーに生じたあらゆる損害について一切の責任を負いません。ただし、本サービスに関する当社とユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されません。消費者契約に該当する場合であっても、当社は、当社の過失（重過失を除きます。）によってユーザーに生じた損害のうち、ユーザーに直接かつ現実に発生した損害についてのみ賠償責任を負うものとし、また、その賠償額は、本サービスの利用料金の直近1ヶ月分または金1万円のいずれか低い方を上限とします。
        </p>
        ...
        <h2 className="text-xl font-semibold mb-2 mt-4">14. 利用規約の変更</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mb-2 mt-4">16. 通知または連絡</h2>
        <p>
          ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-4">17. 権利義務の譲渡</h2>
        <p>
          ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-4">18. 適用関係</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mb-2 mt-4">19. 分離可能性</h2>
        <p>
      ...
      <footer className="mt-8 text-center">
        <p>© 2024 Be Fit. All rights reserved.</p>
      </footer>
    </div>
  );
};
